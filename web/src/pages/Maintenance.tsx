...
function Maintenance() {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchQuery, statusFilter, filterDate, maintenanceRequests.length, filteredMaintenance.length]);
          ...
          <div className="flex flex-col gap-4 md:gap-6 w-full max-w-full">
            <div className="w-full bg-white rounded-xl p-4 md:p-6 lg:p-8 border border-gray-100 shadow-sm">
              ...
              {loading && maintenanceRequests.length === 0 ? (
                ...
                (() => {
                  const displayed = (statusFilter !== 'all' || filterDate || searchQuery) ? filteredMaintenance : maintenanceRequests;
